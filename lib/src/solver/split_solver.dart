...
import 'package:resizable_splitter/src/solver/split_solution.dart';

export 'package:resizable_splitter/src/solver/split_solution.dart';
...
@immutable
@internal
class SplitterSolverConfig with EquatableMixin {
