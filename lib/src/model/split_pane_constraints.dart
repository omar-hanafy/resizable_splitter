...
/// {@category Layout}
@immutable
class SplitterPaneConstraints with EquatableMixin {
  /// Creates pane constraints.
  ///
  /// [SplitterPaneConstraints.maxExtent] must be `>=` [minExtent]. [collapsedExtent], when set, marks the
  ...
  @override
  List<Object?> get props => [minExtent, maxExtent, collapsedExtent];
...
/// case). It only takes effect when both panes have a finite [SplitterPaneConstraints.maxExtent] whose
/// sum is below the available space. The default, [leaveGap], keeps [SplitterPaneConstraints.maxExtent]
