...
import 'package:resizable_splitter/src/theme/resizable_splitter_theme.dart';
import 'package:resizable_splitter/src/model/split_animation.dart';
...
part 'split_animator.dart';
part 'split_pointer_router.dart';
part 'split_handle.dart';
part 'split_restoration.dart';
part 'render_resizable_splitter.dart';
part 'split_geometry.dart';
part 'split_render_widget.dart';
part 'drag_session.dart';
part 'handle_intents.dart';
...
class _ResizableSplitterState extends State<ResizableSplitter>
  ...
  Widget build(BuildContext context) {
    ...
    final keyboardStep =
        widget.keyboardStep ??
        theme.keyboardStep ??
        SplitterDefaults.keyboardStep;
    final pageStep =
        widget.pageStep ?? theme.pageStep ?? SplitterDefaults.pageStep;
    ...
    final fallbackExtent =
        ...
        SplitterDefaults.fallbackExtent;
